...
Thank you for contributing. Nimbus is a complex student project now: storage,
HTTP transport, AI provider abstraction, a shared runtime, signed wrapper auth,
...
- From [My Approach to Building Large Technical Projects](https://mitchellh.com/writing/building-large-technical-projects): break work into chunks that produce visible progress, use tests as early results, and sprint toward demos instead of trying to perfect every subsystem first.
...
## Step 4: Aim for a Demo-Sized Patch

Large technical work should still produce visible progress quickly. In Nimbus,
a good demo-sized change usually has one of these shapes:
