...
The shipped storage backend is AWS S3. Multi-cloud readiness means the public
contract avoids S3-only nouns and callers program to `CloudStorageClient`; it
does not mean this repo already includes GCS, Azure Blob, Dropbox, or Drive
implementations.
