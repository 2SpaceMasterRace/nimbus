...
|---|---|---|
| CLI/model-exposed tools | `openrouter_ai_client_impl/cloud_storage_tools.py` | The model calls a tool directly. |
| Wrapper runtime actions | `nimbus_runtime/runtime.py` | The runtime should enforce safety before or instead of model execution. |
