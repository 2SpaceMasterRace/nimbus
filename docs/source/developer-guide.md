...
| OpenRouter implementation | `openrouter_ai_client_impl` | pydantic-ai/OpenRouter model loop and CLI |
| Runtime | `nimbus_runtime` | Transport-neutral chat/session/tool orchestration |
