...
This glossary is distilled from the canonical
{doc}`../complete-system-design`. Current code and package docs are used as
cross-checks for "what exists today"; the complete system design is the primary
