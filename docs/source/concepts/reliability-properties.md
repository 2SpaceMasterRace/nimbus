...
This catalog translates the {doc}`../complete-system-design` reliability model
into properties reviewers and test authors can check. A property is a claim the
...
design targets for the action/event kernel described in the canonical system
design.
