...
This page maps the concept section to the canonical
{doc}`../complete-system-design`. It replaces the old reading map for the three
draft agent-platform design passes.
...
- {doc}`../complete-system-design` for the full architecture and roadmap.
