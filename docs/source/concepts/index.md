...
This section is the field guide for Nimbus terminology, built from the canonical
{doc}`../complete-system-design` and cross-checked against the current package
docs. Nimbus is trying to become a compact, event-backed AI runtime with durable
actions, verification artifacts, and deterministic reliability tests.
