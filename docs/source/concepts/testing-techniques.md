...
Nimbus is small enough to keep tests fast, but the agent-platform design docs
make the future risk model clear: operation envelopes, session events, action
...
The 3.0 design splits this into four corpora:
