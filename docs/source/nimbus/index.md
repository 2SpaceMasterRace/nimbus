...
| `nimbus_runtime` | Transport-neutral chat orchestration, sessions, stream replay, durable actions, artifacts, confirmation flows, attachment uploads, telemetry |
...
The canonical system design now lives in {doc}`../complete-system-design`.
The pages in this section are the maintained runtime path for HW3.
