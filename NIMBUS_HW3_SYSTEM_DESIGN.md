...
- Deployment/IaC and deep testing design will be handled later, but the runtime
  shape must leave room for them cleanly.
...
- legacy `/ai/chat` still exists for the older API-key path
