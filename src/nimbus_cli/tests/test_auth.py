...
def test_remote_auth_headers_bearer_returns_authorization_header() -> None:
    ...
    headers = remote_auth_headers(profile=profile, secrets=secrets, body=b"{}")
    assert headers["Authorization"] == "Bearer tok-abc"


def test_remote_auth_headers_bearer_raises_when_token_missing() -> None:
    profile = NimbusProfile(
        name="prod",
        mode="remote",
        remote_base_url="https://example.com",
