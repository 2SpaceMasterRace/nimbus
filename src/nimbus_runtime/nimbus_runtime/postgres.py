...
def migrate(database_url: str | None = None) -> None:
    ...
    with transaction(database_url) as con:
        ...
        con.execute(
            """
            ALTER TABLE actions
            ADD COLUMN IF NOT EXISTS policy_decision_json TEXT
            """
        )
        con.execute(
            """
        ...
        con.execute(
            ...
            CREATE TABLE IF NOT EXISTS search_documents (
                ...
                visible_actor_ids TEXT[] NOT NULL DEFAULT '{}',
                visible_channel_ids TEXT[] NOT NULL DEFAULT '{}',
        ...
        con.execute(
            """
            CREATE INDEX IF NOT EXISTS search_chunks_search_vector
