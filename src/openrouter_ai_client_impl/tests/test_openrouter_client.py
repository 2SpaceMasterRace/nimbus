...
def test_build_model_passes_configured_timeout_to_openai_client(
    ...
    model = client._build_model("primary/model:free")  # noqa: SLF001 - exercising constructor wiring directly
...
def test_api_status_error_4xx_raises_provider_error_directly() -> None:
    """A 4xx status that is not 429 must raise AIProviderError without a fallback attempt."""  # noqa: E501
