...
# ``:free``. Primary and fallback run on different upstreams (Novita vs
# DeepInfra) so a single provider outage doesn't take out both.
DEFAULT_MODEL = "openai/gpt-oss-120b:free"
DEFAULT_FALLBACK_MODEL = "nousresearch/hermes-3-llama-3.1-405b:free"
