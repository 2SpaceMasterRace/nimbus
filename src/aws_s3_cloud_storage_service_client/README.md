...
```python
from aws_s3_cloud_storage_service_client.models import MyDataModel
from aws_s3_cloud_storage_service_client.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `aws_s3_cloud_storage_service_client.api.default`
