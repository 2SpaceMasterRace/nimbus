...
* :class:`Tool`, :class:`ToolCallRequest`, :class:`ToolCallRecord`,
  ...
  :class:`AgentEvent`, :class:`AIStreamEvent`, :class:`AuditEvent`,
  :class:`Role` — shared value types passed across the interface.
...
from ai_client_api.client import register_client_factory as register_client_factory
...
from ai_client_api.models import AIStreamEvent as AIStreamEvent
from ai_client_api.models import AIStreamEventKind as AIStreamEventKind
