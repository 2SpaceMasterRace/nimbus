...
multi-turn conversations, tool calling, usage accounting, events, and domain
errors. It has no provider SDK dependencies and contains no OpenRouter-specific
logic.
