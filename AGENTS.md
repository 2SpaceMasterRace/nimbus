...
# ai_server
export AI_SERVER_API_KEY="..."          # shared secret for X-API-Key header
...
# Set the session directory and API key as secrets:
flyctl secrets set AI_SESSION_DIR=/data/sessions AI_SERVER_API_KEY=<key>
